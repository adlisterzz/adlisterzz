<!-- Carousel
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item">
          <img class="third-slide" src="/img/Propaniacs.png" alt="Third slide">
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="accessories.index.php" role="button">Browse gallery</a></p>
            </div>
          </div>
        </div>
      </div>
